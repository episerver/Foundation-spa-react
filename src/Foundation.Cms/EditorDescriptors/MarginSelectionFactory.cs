    ...
    public class MarginSelectionFactory : ISelectionFactory
    {
        ...
        public IEnumerable<ISelectItem> GetSelections(ExtendedMetadata metadata)
        {
            return new ISelectItem[]
            {
                ...
                new SelectItem { Text = _localizationService.GetString("Medium", "Medium"), Value = "m-lg-3" },
                new SelectItem { Text = _localizationService.GetString("Large", "Large"), Value = "m-lg-5" },
            };
        }
    }
}
