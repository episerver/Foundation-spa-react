...
export class ThreeColumnLandingPageType extends BaseIContent<ThreeColumnLandingPageData> implements ThreeColumnLandingPageData {
     ...
     * No description available
     */
    public centerColumn: NumberProperty;
