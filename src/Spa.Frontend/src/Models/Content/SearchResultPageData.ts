 ...
 */
export default interface SearchResultPageData extends IContent {
    /**
     * Categories
     *
     ...
     */
    showRecommendations: BooleanProperty
 ...
 */
export interface SearchResultPageProps extends ComponentProps<SearchResultPageData> {}

export class SearchResultPageType extends BaseIContent<SearchResultPageData> implements SearchResultPageData {
     ...
     * This will determine whether or not to show recommendations
     */
    public showRecommendations: BooleanProperty;
