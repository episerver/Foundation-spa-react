 ...
 */
export default interface ResetPasswordMailPageData extends IContent {
    /**
     * Subject
     *
 ...
 */
export interface ResetPasswordMailPageProps extends ComponentProps<ResetPasswordMailPageData> {}

export class ResetPasswordMailPageType extends BaseIContent<ResetPasswordMailPageData> implements ResetPasswordMailPageData {
