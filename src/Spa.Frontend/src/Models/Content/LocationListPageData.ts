...
export class LocationListPageType extends Taxonomy.AbstractIContent<LocationListPageData> implements LocationListPageData {
     ...
     * No description available
     */
    public get teaserButtonColor() : LocationListPageData["teaserButtonColor"] { return this.getProperty("teaserButtonColor"); }
     ...
     * No description available
     */
    public get teaserButtonTextColor() : LocationListPageData["teaserButtonTextColor"] { return this.getProperty("teaserButtonTextColor"); }
