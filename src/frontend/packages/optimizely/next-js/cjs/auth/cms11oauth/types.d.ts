...
export declare type ServiceToken = {
    access_token: string;
    token_type: 'bearer';
    expires_in: number;
...
export declare type Provider = (options: Partial<Config>) => CredProvider.CredentialsConfig<Credentials>;
export declare type JWTCallback = CallbacksOptions<Profile, Account>['jwt'];
export declare type SessionCallback = CallbacksOptions<Profile, Account>['session'];
export declare type RedirectCallback = CallbacksOptions<Profile, Account>['redirect'];
export declare type SignInCallback = CallbacksOptions<Profile, Account>['signIn'];
