...
export declare function loadPageContentByUrl(url: URL | string, api: ContentDelivery.IContentDeliveryAPI, locale?: string, inEditMode?: boolean): Promise<PageRenderingProps | undefined>;
/**
