...
export type OptiCms12Config<P = any> = Partial<Omit<OAuthConfig<P>, 'wellKnown' | 'clientId' | 'clientSecret'>> & Pick<Required<OAuthConfig<P>>, 'clientId'> & Pick<OAuthConfig<P>, 'clientSecret'> & {
    host: string;
    scopes?: string[];
};
