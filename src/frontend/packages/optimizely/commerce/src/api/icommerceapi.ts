...
export const enum CommerceEndpoints {
...
export function isCommerceApi(api: ContentDelivery.IContentDeliveryAPI) : api is ICommerceApi
{
    return typeof((api as ICommerceApi).getPricing) === 'function'
}

export type IContentList = Models.ContentReference | Models.ContentReference[]
