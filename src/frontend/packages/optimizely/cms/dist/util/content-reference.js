...
export function referenceIsString(ref) {
    return typeof (ref) === 'string' && ref.length > 0;
}
export function contentApiIdIsGuid(apiId) {
 ...
 */
export function createLanguageId(reference, languageCode, inEditMode = false) {
 ...
 */
export function createApiId(id, preferGuid = true, inEditMode = false) {
