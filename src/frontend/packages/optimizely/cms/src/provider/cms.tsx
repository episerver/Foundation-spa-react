...
export const OptimizelyCmsContext = React.createContext<OptimizelyCmsContextData>({
...
export const OptimizelyCms : FunctionComponent<PropsWithChildren<OptimizelyCmsProps>> = ({ children, cmsDomain, defaultBranch, defaultSiteId, ComponentLoaderClass, components }) => {
    const providerProps = useMemo<OptimizelyCmsContextData>(() => {
        if (DEBUG) {
