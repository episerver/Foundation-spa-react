...
export type PropertyDataType<ValueType> =
    ...
    ValueType extends string ? "PropertyLongString" | "PropertyString" | "PropertyXhtmlString" :
    ValueType extends number ? "PropertyInt" | "PropertyNumber" | "PropertyFloatNumber" :
    ValueType extends boolean ? "PropertyBoolean" :
    ValueType extends Weblink ? "PropertyLink" :
    ValueType extends Weblink[] ? "PropertyLinkCollection" :
    ValueType extends IContent ? "PropertyBlock" :
    string;
