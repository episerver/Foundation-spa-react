 ...
 */
export type ChangeType<Tin, Field extends keyof Tin, NewType> = Omit<Tin, Field> & { [ Field in keyof Tin ] : NewType }
 ...
 * extension
 */
export type ExtendType<Tin, TExtension> = Omit<Tin, keyof TExtension> & TExtension