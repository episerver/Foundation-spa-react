...
namespace HeadlessCms.Features.Settings
{
    ...
    public class ScriptInjectionSettings : SettingsBase
    {
        ...
        [JsonIgnore]
        [CultureSpecific]
        [Display(Name = "Header Scripts (Scripts will inject at the bottom of header)", GroupName = "Scripts", Description = "Scripts will inject at the bottom of header", Order = 10)]
        ...
        [JsonIgnore]
        [CultureSpecific]
        [Display(Name = "Footer Scripts (Scripts will inject at the bottom of footer)", GroupName = "Scripts", Description = "Scripts will inject at the bottom of footer", Order = 20)]
        [EditorDescriptor(EditorDescriptorType = typeof(CollectionEditorDescriptor<ScriptInjectionModel>))]
